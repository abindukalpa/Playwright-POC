...
export const launchGame = async (page: Page, gameName, consoleMessages: string[]) => {
    ...
    await validateConsoleMessages("gameLoadComplete", consoleMessages, [4_000, 6_000, 8_000, 15_000]);
  }
